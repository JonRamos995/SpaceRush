...
namespace SpaceRush.Systems
{
    public class FleetManager : MonoBehaviour
    {
        ...
        public bool AutoRepairUnlocked => ResearchManager.Instance != null && ResearchManager.Instance.IsFeatureUnlocked("REPAIR_DROID");
        ...
        private void AttemptAutoRepair()
        {
            ...
            {
                RepairShip(0.5f); // Slow free repair fallback
            }
        }
